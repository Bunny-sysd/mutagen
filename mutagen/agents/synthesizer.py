...
"""
        ...
        try:
            ...
            if valid_payloads_added == 0:
                ...
                if context.delivery_mode == "file":
                    for fb in _generate_file_mode_fallback_payloads():
                        context.active_payloads.append(CrashPayload(args=["poc_fallback.png"], input_data="", raw_bytes_hex=fb["raw_bytes_hex"]))
                else:
                    context.active_payloads.append(CrashPayload(args=["A" * 64], input_data="A" * 64))
            ...
            if context.delivery_mode == "file":
                ...
                context.active_payloads.append(CrashPayload(args=["A" * 64], input_data="A" * 64, reason="Fallback due to execution error"))
